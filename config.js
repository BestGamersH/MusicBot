module.exports = {
	...
	adminId: "903413084004163644", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "MTAyNjc1MDY0Njc3NjQ5NjE4MA.GcKa2N.R7B4IZUcCn2nDOsSlkkEZDDjIc1VOjrsKW1hgM", //- Bot's Token
	clientId: process.env.clientId || "1026750646776496180", //- ID of the bot
	clientSecret: process.env.clientSecret || "T6LZezmMsXho01aAbB0fiByFpNdhqVFR", //- Client Secret of the bot
	...
	cookieSecret: "BestGamersHK is op", //- Cookie Secret
	...
	presence: {
		...
		activities: [
			{
				name: "Music | {prefix}help", //- Status Text
